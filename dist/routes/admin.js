...
adminRouter.get("/products", is_auth_1.isAuth, admin_controller_1.getProductsController);
...
], is_auth_1.isAuth, admin_controller_1.createProductController);
...
], is_auth_1.isAuth, admin_controller_1.updateProductController);
adminRouter.delete("/products/:prodId", [(0, express_validator_1.param)("prodId").trim().notEmpty().withMessage("Product ID is required")], is_auth_1.isAuth, admin_controller_1.deleteProductController);
